...
def remove_html_tags(text: str) -> str:
    ...
    # Use the get_text() method to extract text content without HTML tags
...
def stem_text(text: str) -> str:
    ...
    # Apply stemming to each word and join them back into a string
...
def lemmatize_text(text: str) -> str:
    ...
    # Extract lemmas for each token in the processed text
    lemmatized_tokens = [token.lemma_ for token in doc]
    
    # Join the lemmatized tokens back into a string
    lemmatized_text = ' '.join(lemmatized_tokens)
    
    return str(lemmatized_text)
...
def remove_extra_new_lines(text: str) -> str:
    ...
    # Use re.sub to replace consecutive newlines and tabs with a single space
