...
def get_performance(
    ...
    precision = precision_score(predictions, y_test, average='binary')
    # Use sklearn.metrics.recall_score
    recall = recall_score(predictions, y_test, average='binary')
    # Use sklearn.metrics.f1_score
    f1score = f1_score(predictions, y_test, average='binary')
    # Use sklearn.metrics.classification_report
    report = classification_report(predictions, y_test, labels=labels)

    # Get Confusion Matrix, use sklearn.metrics.confusion_matrix
    cm = confusion_matrix(predictions, y_test, labels = labels)
